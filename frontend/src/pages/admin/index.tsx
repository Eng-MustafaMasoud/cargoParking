...
const AdminDashboard = () => {
  ...
  const handleZoneToggle = (zoneId: string, isOpen: boolean) => {
              ...
              <div className="card">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {parkingReport.reduce((sum: number, zone: any) => sum + zone.occupied, 0)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {parkingReport.reduce((sum: number, zone: any) => sum + zone.free, 0)}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-2xl font-semibold text-gray-900">
                      {parkingReport.reduce((sum: number, zone: any) => sum + (zone.subscriberCount || 0), 0)}
                    </p>
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'control' && (
          <div className="space-y-6">
            <div className="card">
              ...
              <p className="text-gray-600">Zone and rate management features coming soon...</p>
            </div>
          </div>
        )}
      </div>
