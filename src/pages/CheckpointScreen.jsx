...
const CheckpointScreen = () => {
  ...
  // Fetch subscription if ticket is subscriber type
  const { data: subscription } = useQuery({
    queryKey: ['subscription', ticket?.subscriptionId],
    queryFn: () => apiClient.getSubscription(ticket.subscriptionId),
        ...
        {ticket && (
          <div className="card mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {/* Subscription Cars (if applicable) */}
              {ticket.type === 'subscriber' && subscription && (
                <div>
                  <label className="text-sm font-medium text-gray-600">Subscription Cars</label>
